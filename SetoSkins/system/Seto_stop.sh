...
sleep 10s
  ...
  if [ ! -f "/sys/class/power_supply/battery/input_suspend" ] || [ ! -f "/sys/class/power_supply/battery/battery_charging_enabled" ] || [ ! -f "/sys/class/battery/input_suspend" ] || [ ! -f "/sys/class/power_supply/battery/input_suspend" ] || [ ! -f "/sys/class/qcom-battery/input_suspend" ];then
...
echo 0 > /sys/class/battery/input_suspend
